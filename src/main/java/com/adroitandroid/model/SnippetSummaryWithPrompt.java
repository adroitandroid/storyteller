...
public class SnippetSummaryWithPrompt implements Serializable {
    ...
    public SnippetSummaryWithPrompt(Long id, Long parentId, String snippetText, Boolean isEnd, Long userVotes,
                                    Long promptId, String prompt, Date promptStartDate, Date promptEndDate,
                                    Date promptCreateTime, Date promptUpdateTime) {
        this.snippetSummary = new SnippetSummary(id, parentId, snippetText, isEnd, userVotes);
