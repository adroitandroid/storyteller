...
interface StorySnippetRepository extends CrudRepository<StorySnippet, Long> {
    ...
    List<SnippetSummaryWithPrompt> getAllSnippetsWithVoteCountForPrompt(long promptId);
    ...
    List<SnippetSummaryWithPrompt> getAllSnippetsWithVoteCountOnActivePromptsForUser(long userId, Date date);
}
