...
CREATE TABLE user_progression (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, progression VARCHAR(30) NOT NULL, status TINYINT NOT NULL DEFAULT 0, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES user(id)) ENGINE=INNODB;
