...
INSERT INTO user_auth_type VALUES (DEFAULT, 'facebook'), (DEFAULT, 'phone');

CREATE TABLE user (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, username VARCHAR(30), auth_type_id MEDIUMINT NOT NULL, auth_user_id VARCHAR(255) NOT NULL, last_login DATETIME NOT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (auth_type_id) REFERENCES user_auth_type(id)) ENGINE=INNODB;
